...
function instrumentFetch() {
  ...
  fill(WINDOW3, "fetch", function(originalFetch) {
    return function(...args) {
      ...
      return originalFetch.apply(WINDOW3, args).then((response) => {
        triggerHandlers("fetch", {
          ...handlerData,
...
function createTransport(options, makeRequest, buffer = makePromiseBuffer(options.bufferSize || DEFAULT_TRANSPORT_BUFFER_SIZE)) {
  ...
  function send(envelope) {
    ...
    const requestTask = () => makeRequest({ body: serializeEnvelope(filteredEnvelope, options.textEncoder) }).then((response) => {
...
//# sourceMappingURL=chunk-V4Y5MC3S.js.map
